  ...
  <div class="main">
    <el-form ref="formRef" :inline="true" :model="form" class="search-form bg-bg_color w-[99/100] pl-8 pt-[12px] overflow-auto">
      <el-form-item label="角色名称：" prop="role_name">
        <el-input v-model="form.role_name" placeholder="请输入角色名称" clearable class="!w-[180px]" />
      </el-form-item>
      <el-form-item>
    ...
    <div ref="contentRef" :class="['flex', deviceDetection() ? 'flex-wrap' : '']">
        ...
        <template v-slot="{ size, dynamicColumns }">
          ...
          >
            <template #operation="{ row }">
              ...
              <el-button class="reset-margin" link type="primary" :size="size" :icon="useRenderIcon(Delete)" @click="handleMenu(row)"> 权限 </el-button>
            </template>
          </pure-table>
        </template>
      </PureTableBar>
      ...
      <div v-if="isShow" class="!min-w-[calc(100vw-60vw-268px)] mt-2 px-2 pb-2 bg-bg_color ml-2 overflow-auto">
        ...
        <el-tree-v2 ref="treeRef" show-checkbox :data="treeData" :props="treeProps" :height="treeHeight" :check-strictly="!isLinkage" :filter-method="filterMethod">
